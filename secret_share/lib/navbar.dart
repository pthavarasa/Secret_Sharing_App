...
class _NavbarState extends State<Navbar> {
  ...
  List<Widget> _widgetOptions = <Widget>[Receive(), Split(), Combine(), Info()];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Center(child: Text('Secret Sharing App'))),
        body: Center(child: _widgetOptions.elementAt(_selectedNavIdex)),
        bottomNavigationBar: BottomNavigationBar(
          type: BottomNavigationBarType.fixed,
          items: const <BottomNavigationBarItem>[
            BottomNavigationBarItem(
                icon: Icon(Icons.save_alt), label: 'Receive'),
            BottomNavigationBarItem(
                icon: Icon(Icons.alt_route_sharp), label: 'Split'),
            BottomNavigationBarItem(
                icon: Icon(Icons.animation), label: 'Combine'),
            BottomNavigationBarItem(
